...
check_mk agent v2.5.0pXX: [CURRENT, EOL (28.04.2028)](https://docs.checkmk.com/latest/en/cmk_versions.html)  
<https://raw.githubusercontent.com/donimax/unraid-check-mk-agent/master/check_mk_agent25.plg>

check_mk agent v2.4.0pXX: [EOL (06.11.2027)](https://docs.checkmk.com/latest/en/cmk_versions.html)  
